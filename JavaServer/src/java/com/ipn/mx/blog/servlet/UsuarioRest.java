...
public class UsuarioRest extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(accion == null){
                ...
                case "LOGIN":
                    ...
                    break;
                case "INSERT":
                    insertUsuario(request, response, out);
                    break;
                case "UPDATE":
    ...
    private void insertUsuario(HttpServletRequest request, HttpServletResponse response, PrintWriter out) throws IOException {
